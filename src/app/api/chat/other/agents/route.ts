...
import {
  getDiscoveryCallDetails,
  getSimilarCoursesTool,
  getWeatherTool,
} from "@/lib/tools";
...
const DEFAULT_PROMPT = `Role: You are a helpful assistant that will answer any tech question for user. If unsure, say “I do not know".`;
...
const AGENT_SYSTEM_TEMPLATE = DEFAULT_PROMPT;
