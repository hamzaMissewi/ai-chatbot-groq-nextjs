...
// import { createCheckoutSession } from "@/lib/premium-subs";
// import { useRouter } from "next/navigation";
...
const plans: {
  ...
  },
  {
    ...
    priceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_ID_PRO_PLUS_MONTHLY!, //"price_yyyy", // Add your Stripe price ID here
  },
];
                ...
                {plans.map((plan) => (
                  <div
                    ...
                    className={`flex flex-col justify-between rounded-3xl bg-white p-8 ring-1 ring-gray-200 xl:p-10 ${
                      plan.name === "Pro" ? "lg:z-10 lg:rounded-b-none" : ""
                    }`}
                  >
                    <div>
                    ...
                    <Button
                      ...
                      disabled={
                        loading === plan.name ||
                        (plan.value === subscriptionLevel && isSignedIn)
                      }
                    >
                      {loading === plan.name
                        ? "Loading..."
