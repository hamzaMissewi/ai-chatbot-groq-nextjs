          ...
          <div className="flex items-center gap-6">
            <div className="group relative">
              <img
                src={user?.imageUrl}
                alt="Profile"
                className="h-24 w-24 cursor-pointer rounded-full border-4 border-black"
              />
              {/*   <Upload
              ...
              {/* </div> */}
              <div className="absolute -top-8 left-0 right-0 flex w-full items-center justify-around gap-2">
                <Camera
                  className="h-7 w-7 cursor-pointer rounded-full bg-black/80 p-1 text-white opacity-40 transition-opacity group-hover:opacity-100"
                  onClick={() => inputRef.current?.click()}
                />
                <Eye
                  className="h-7 w-7 cursor-pointer rounded-full bg-black/80 p-1 text-white opacity-40 transition-opacity group-hover:opacity-100"
