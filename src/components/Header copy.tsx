...
export default function Header({ onMenuClick }: HeaderProps) {
  ...
  return (
    ...
    // items-center justify-between border-b border-
    // [#00ff99] bg-white px-2 backdrop-blur-xl"></header>
    <header className="fixed top-0 z-50 flex w-full items-center justify-between border-b border-[#00ff99] bg-white px-4 backdrop-blur-xl">
      <ConfirmDialog />
      <div
        className={cn(
          "flex w-full items-center justify-between",
          hideHeader ? "h-0 p-0 opacity-0" : "",
        )}
      >
